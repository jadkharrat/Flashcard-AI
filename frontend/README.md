...
The RecallAI web client is a React and TypeScript application built with Vite. It provides account creation and sign-in, a no-account sample workspace, PDF upload validation, AI-generated flashcard decks, accessible card controls, and responsive light/dark themes.
